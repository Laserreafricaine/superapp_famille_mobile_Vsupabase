const CACHE = 'superapp-famille-v5-36-14';
const CORE_ASSETS = ['./', './index.html', './css/app.css?v=5.36.14', './js/app.js?v=5.36.14', './js/supabase-client.js?v=5.36.14', './js/supabase-app.js?v=5.36.14', './css/supabase-auth.css?v=5.36.14', './manifest.json?v=5.36.14'];
